...
# 1. Cargar archivos
csv_origen = "df_limpio_con_repeticiones.csv"  # tu CSV original
...
# 3. Función para buscar municipio usando fuzzy matching
...
# 7. Guardar CSV final
output_path = "df_unico_municipios_repeticiones.csv"
